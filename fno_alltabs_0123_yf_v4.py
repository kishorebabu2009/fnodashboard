...
SECTOR_MAP = {
    "AUTO": [
        ...
        "FORCEMOT", "HEROMOTOCO", "HYUNDAI", "M&M", "MARUTI", 
        "MOTHERSON", "SONACOMS", "TIINDIA", "TMPV", "TVSMOTOR", 
        "UNOMINDA"
    ],
    "BANKING": [
        "AUBANK", "AXISBANK", "BANDHANBNK", "BANKBARODA", "BANKINDIA", 
        "CANBK", "FEDERALBNK", "HDFCBANK", "ICICIBANK", "IDFCFIRSTB", 
        "INDIANB", "INDUSINDBK", "KOTAKBANK", "PNB", "RBLBANK", 
        "SBIN", "UNIONBANK", "YESBANK", "CENTRALBK", "IDBI", 
        "IOB", "UCOBANK"
    ],
    "CHEMICALS": [
        "ATUL", "COROMANDEL", "DEEPAKNTR", "GROWWCHEM", "GUJGASLTD", 
        "PIDILITIND", "PIIND", "SOLARINDS", "SRF", "TATACHEM", 
        "UPL"
    ],
    "CONSUMER_FMCG": [
        "BRITANNIA", "COLPAL", "DABUR", "GODFRYPHLP", "GODREJCP", 
        "HINDUNILVR", "ITC", "MARICO", "NESTLEIND", "PATANJALI", 
        "RADICO", "TATACONSUM", "UNITDSPR", "VBL"
    ],
    "CONSUMER_DURABLES": [
        "AMBER", "ASIANPAINT", "BLUESTARCO", "CROMPTON", "DIXON", 
        "HAVELLS", "KALYANKJIL", "KAYNES", "METROBRAND", "PAGEIND", 
        "PGEL", "TITAN", "VOLTAS"
    ],
    "DEFENSE/INFRA": [
        "ABB", "ADANIENT", "ADANIPORTS", "AMBUJACEM", "APLAPOLLO", 
        "ASTRAL", "BDL", "BEL", "BHEL", "CGPOWER", 
        "COCHINSHIP", "CONCOR", "CUMMINSIND", "DALBHARAT", "GMRAIRPORT", 
        "GRASIM", "GVT&D", "HAL", "IRB", "LT", 
        "LTTS", "MAZDOCK", "POLYCAB", "POWERINDIA", "RVNL", 
        "SHREECEM", "SIEMENS", "SUPREMEIND", "ULTRACEMCO"
    ],
    "ENERGY/OIL": [
        "ADANIENSOL", "ADANIGREEN", "ADANIPOWER", "BPCL", "COALINDIA", 
        "GAIL", "HINDPETRO", "INOXWIND", "IOC", "IREDA", 
        "JSWENERGY", "NHPC", "NTPC", "OIL", "ONGC", 
        "PETRONET", "POWERGRID", "PREMIERENE", "RELIANCE", "SJVN", 
        "SUZLON", "TATAPOWER", "TORNTPOWER", "WAAREEENER"
    ],
    "FINANCE": [
        "360ONE", "ABCAPITAL", "ANGELONE", "BAJAJFINSV", "BAJAJHLDNG", 
        "BAJFINANCE", "BSE", "CAMS", "CDSL", "CHOLAFIN", 
        "HDFCAMC", "HDFCLIFE", "HUDCO", "ICICIGI", "ICICIPRULI", 
        "IEX", "IIFL", "IRFC", "JIOFIN", "LICHSGFIN", 
        "LICI", "LTF", "MANAPPURAM", "MCX", "MFSL", 
        "MUTHOOTFIN", "NUVAMA", "PFC", "PNBHOUSING", "POLICYBZR", 
        "POONAWALLA", "RECLTD", "SAMMAANCAP", "SBICARD", "SBILIFE", 
        "SHRIRAMFIN"
    ],
    "HEALTHCARE": [
        "ALKEM", "APOLLOHOSP", "AUROPHARMA", "BIOCON", "CIPLA", 
        "DIVISLAB", "DRREDDY", "FORTIS", "GLAND", "GLENMARK", 
        "GRANULES", "LAURUSLABS", "LUPIN", "MANKIND", "MAXHEALTH", 
        "PPLPHARMA", "SUNPHARMA", "SYNGENE", "TORNTPHARM", "ZYDUSLIFE"
    ],
    "IT": [
        "BSOFT", "COFORGE", "HCLTECH", "INFY", "KFINTECH", 
        "KPITTECH", "LTIM", "MPHASIS", "OFSS", "ORACLE", 
        "PERSISTENT", "TATAELXSI", "TATATECH", "TCS", "TECHM", 
        "WIPRO"
    ],
    "METALS": [
        "HINDALCO", "HINDZINC", "JINDALSTEL", "JSL", "JSWSTEEL", 
        "NATIONALUM", "NMDC", "SAIL", "TATASTEEL", "VEDL"
    ],
    "PLATFORMS/MISC": [
        "BHARTIARTL", "DELHIVERY", "DMART", "ETERNAL", "IDEA", 
        "INDHOTEL", "INDIAMART", "INDIGO", "INDUSTOWER", "JUBLFOOD", 
        "NAUKRI", "NYKAA", "PAYTM", "PBSTECH", "SWIGGY", 
        "TRENT", "VMM", "ZOMATO"
    ],
    "REALTY": [
